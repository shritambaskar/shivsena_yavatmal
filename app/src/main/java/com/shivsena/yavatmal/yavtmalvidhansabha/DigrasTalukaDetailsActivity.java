...
public class DigrasTalukaDetailsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_digras_taluka_details);
        ...
        talukaSpinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                talukaRecycler.setLayoutManager(new LinearLayoutManager(DigrasTalukaDetailsActivity.this));
                list = new ArrayList<>();
                shiv_adapter = new ShivsenaAdapter(DigrasTalukaDetailsActivity.this,list);
    ...
    private void showData() {
        mRef.addValueEventListener(new ValueEventListener() {
            ...
            @Override
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(DigrasTalukaDetailsActivity.this, "Error "+error.getMessage(), Toast.LENGTH_SHORT).show();
            }
    ...
    private void initialise() {
        talukaSpinner = findViewById(R.id.digras_taluka_spinner);
        talukaRecycler = findViewById(R.id.digras_taluka_recycleView);
    }
    ...
    protected void onStart() {
        ...
        adapter = new ArrayAdapter<String>(DigrasTalukaDetailsActivity.this,
